...
insert into a_passi_proc (VOCE_MENU,PASSO,TITOLO,TIPO,MODULO ,GRUPPO_LING,stampa)
values ('PECCADMA',91,'Lista Segnalazioni Denuncia DMA','R','PECLSDMA','N','PECLSDMA')
/
...
/
insert into a_passi_proc (VOCE_MENU,PASSO,TITOLO,TIPO,MODULO ,GRUPPO_LING,stampa)
values ('PECCADMA',93,'Errori di Elaborazione','R','ACARAPPR','N','PECCADMA')
/
insert into a_passi_proc (VOCE_MENU,PASSO,TITOLO,TIPO,MODULO ,GRUPPO_LING)
