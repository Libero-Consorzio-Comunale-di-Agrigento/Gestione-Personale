CREATE OR REPLACE PACKAGE PPOCCSSO2 IS
/******************************************************************************
 NOME:          PPOCCSSO2
 DESCRIZIONE:   
 ARGOMENTI:   
...
FUNCTION  VERSIONE              RETURN VARCHAR2;
  PROCEDURE CC_NOMINATIVO(P_D_F IN VARCHAR2,P_USO_INTERNO IN VARCHAR2, P_PRENOTAZIONE IN NUMBER, P_VOCE_MENU IN VARCHAR2);
END;
/
CREATE OR REPLACE PACKAGE BODY PPOCCSSO2 IS
...
END;
PROCEDURE CC_NOMINATIVO (P_D_F IN VARCHAR2,P_USO_INTERNO IN VARCHAR2, P_PRENOTAZIONE IN NUMBER, P_VOCE_MENU IN VARCHAR2) IS
