CREATE OR REPLACE PACKAGE gp4_clfu IS
/******************************************************************************
 NOME:        GP4_clfu
...
END gp4_clfu;
/
CREATE OR REPLACE PACKAGE BODY gp4_clfu AS
   FUNCTION versione
      RETURN VARCHAR2 IS
/******************************************************************************
 NOME:        VERSIONE
...
--
   FUNCTION get_descrizione (
      ...
      RETURN VARCHAR2 IS
      d_descrizione   classificazioni_funzionali.descrizione%TYPE;
/******************************************************************************
 NOME:        VERSIONE
 DESCRIZIONE: Restituisce la  descrizione del funzionale indicato
 PARAMETRI:   --
 RITORNA:     stringa varchar2 ruolenente versione e descrizione.
******************************************************************************/
   BEGIN
