CREATE OR REPLACE PACKAGE peccmocp5 IS
/******************************************************************************
 NOME:        PECCMOCP5
 DESCRIZIONE: Emissione Voci ad Estrazione - Previsione
 ANNOTAZIONI: -
 REVISIONI:
 ...
 5    28/06/2005  CB    Gestione Codice_siope
******************************************************************************/
...
CREATE OR REPLACE PACKAGE BODY peccmocp5 IS
