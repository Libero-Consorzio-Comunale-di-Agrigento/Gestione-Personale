REM            creazione delle viste specifiche della Dotazione Organica che NON sono
REM            INDISPENSABILI per la validazione degli oggetti di DB 

/*==============================================================*/
/* Viste DOTAZIONE_ORGANICA                                     */
/* Versione febbraio 2005                                       */
/*==============================================================*/

/*==============================================================*/
/* View: DOTAZIONE_GESTIONI_FATTO                               */
/*==============================================================*/

CREATE OR REPLACE FORCE VIEW DOTAZIONE_GESTIONI_FATTO
...
select rido.UTENTE
 ...
 where rido.data between pedo.dal
                     and nvl(pedo.al,to_date(3333333,'j'))
   and pedo.door_id=0
	  and pedo.rilevanza = 'S'
	  and pedo.ci>0
...
/*==============================================================*/
/* View: DOTAZIONE_GESTIONI_DIRITTO                             */
/*==============================================================*/
