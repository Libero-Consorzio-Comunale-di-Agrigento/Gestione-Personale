...
REM VIEW
REM      VALORI_CONTABILI_ANNUALI

REM
REM  VALORI_CONTABILI_ANNUALI
REM
REM  Valori contabili estratti dalla mensilita` retributiva
REM  con importo progressdivo annuo
REM
REM  
REM
PROMPT
PROMPT Creating View VALORI_CONTABILI_ANNUALI
CREATE OR REPLACE VIEW VALORI_CONTABILI_ANNUALI
(
     estrazione
    ,ci
    ,anno
...
AS SELECT
     ...
     , ( decode( esrc.tipo 
               ...
               , 'E', nvl(prco.p_ipn_eap,nvl(prco.p_ipn_p,nvl(prco.p_imp,0)))
                    , 0                                
...
WHERE  prco.voce  = esrc.voce
   and prco.sub   = esrc.sub
   and last_day(to_date(to_char(nvl(prco.moco_mese,12))||'/'||to_char(prco.anno),'mm/yyyy'))
                      between esrc.dal
