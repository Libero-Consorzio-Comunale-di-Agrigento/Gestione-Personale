/*<TOAD_FILE_CHUNK>*/
CREATE OR REPLACE PACKAGE PECCSMFG IS
/******************************************************************************
 NOME:          PECCSMFG
 DESCRIZIONE:   
 ARGOMENTI:   
...
CREATE OR REPLACE PACKAGE BODY PECCSMFG IS
            ...
            (select rpad(nvl( D_cod_fis
             ...
             BEGIN
               ...
               --
                    select abs(( nvl(sum(prfi.ipn_ac),0)     
                         ...
                         , decode( nvl(sum(prfi.somme_11),0)
                                 , 0, 'C'
                                    , decode( sum(prfi.somme_11)
                                            , (nvl(sum(prfi.ipn_ac ),0)
                                              +nvl(sum(prfi.ipn_ap ),0)), 'A'
                                                                        , 'B'
                                            )
                                 )                                   contributo
                      into D_totale
             ...
             values ( prenotazione
                    ...
                    , 'G'||
                      ...
                      lpad(' ',35,' ')||
                      lpad(to_char(D_modulo),6,'0')||
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'0100'||
                      rpad(CUR_RPFA.cod_fis,16,' ')||
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'0200'||
                      ...
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'0300'||
             ...
             values ( prenotazione
                    ...
                    , 'SG'||lpad(to_char(D_num_ord),2,'0')||'0300'||
                      ...
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'0400'||
                      rpad(nvl(CUR_RPFA.sesso,' '),16,' ')||
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'0500'||
                      lpad(nvl(CUR_RPFA.data_nas,'0'),16,' ')||
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'0600'||
                      ...
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'0700'||
                      rpad(CUR_RPFA.prov_nas,16,' ')||
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'0800'||
             ...
             values ( prenotazione
                    ...
                    , D_pagina
                    , D_riga
                    , 'SG'||lpad(to_char(D_num_ord),2,'0')||'0900'||
                      rpad(CUR_RPFA.prov_res,16,' ')||
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'1000'||
                      ...
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'1100'||
                      lpad(nvl(CUR_RPFA.nr,'0'),16,' ')||
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'1200'||
                      ...
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'1300'||
                      lpad(nvl(CUR_RPFA.cse,'0'),16,' ')||
                      'SG'||lpad(to_char(D_num_ord),2,'0')||'1400'||
             ...
             ;
                  ...
                  values ( prenotazione
                         ...
                         , D_pagina
                         , D_riga
                         , 'SG'||lpad(to_char(D_num_ord),2,'0')||'1500'||
                           rpad(nvl(CUR_RPFA.causale,' '),16,' ')||
                           'SG'||lpad(to_char(D_num_ord),2,'0')||'1600'||
                           lpad(nvl(D_totale,'0'),16,' ')||
                           'SG'||lpad(to_char(D_num_ord),2,'0')||'1700'||
                           lpad(nvl(D_no_sogg,'0'),16,' ')||
                           'SG'||lpad(to_char(D_num_ord),2,'0')||'1800'||
                           lpad(nvl(D_no_sogg_rc,' '),16,' ')||
                           'SG'||lpad(to_char(D_num_ord),2,'0')||'1900'||
                           lpad(D_ipn_ord,16,' ')||
                           'SG'||lpad(to_char(D_num_ord),2,'0')||'2000'||
                           lpad(D_ipt_ord,16,' ')||
                           'SG'||lpad(to_char(D_num_ord),2,'0')||'2100'||
                           lpad(D_ipt_sosp,16,' ')||
                           'SG'||lpad(to_char(D_num_ord),2,'0')||'2200'||
                           rpad(D_contributo,16,' ')||
                           '}'
                         )
                  ; 
