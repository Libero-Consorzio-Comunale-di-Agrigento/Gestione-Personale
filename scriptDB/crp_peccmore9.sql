...
/******************************************************************************
 ...
 5.3  28/12/2005 NN-AM  Ritenuta AP forzata uguale a Ritenuta dell'anno se i relativi imponibili
                        sono uguali e la differenza tra le ritenute è 0.01 (arrotondamenti).
 ...
 5.13 06/11/2007 NN     In caso di più voci con stessa delibera e riferimento diverso, valorizzava la tariffa
...
--                         AND NVL(caco.competenza,caco.riferimento) = x.riferimento
                         ...
                         AND caco.competenza  = x.competenza        -- per cui è stata prodotta la ritenuta da stornare
                      OR     x.estrazione   = 'RX'
...
-- end if;
        ...
        BEGIN  -- Trattamento singola Voce di Ritenuta
          ...
          BEGIN  -- 18/06/2007 Preleva parametri di imvo se esiste
                 -- se la voce è calcolata su una totalizzazione li forza con valoi convenzionali
...
/* fine modifica del 02/05/2007 */
          ...
          END;
          BEGIN  -- Preleva parametri di valorizzazione Ritenuta
                 -- NON tratta IMVO in join perchè per le voci calcolate ad es. su una
